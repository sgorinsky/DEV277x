public class Accountant extends BusinessEmployee {
  ...
  TechnicalLead TechnicalSupport;
  int supported;
  ...
  //Once this happens the Accountant's bonus budget should be updated to be the total of each
  //SoftwareEngineer's base salary that reports to that TechnicalLead plus 10%.
  // For example, if the TechnicalLead supports 2 SoftwareEngineers, each with a salary of 75000,
  ...
  public String employeeStatus() {
    ...
    return super.employeeStatus() + " and is supporting " + TechnicalSupport.getName();
